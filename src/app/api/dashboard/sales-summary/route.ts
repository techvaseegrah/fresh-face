// /app/api/dashboard/sales-summary/route.ts - MULTI-TENANT REFACTORED VERSION
...
// ===================================================================================
//  GET: Handler to fetch a detailed sales summary for a date range
// ===================================================================================
export async function GET(req: NextRequest) {
  try {
    ...
    // --- MT: Add tenantId to the initial match stage ---
    ...
    const [invoiceReport, cancelledAppointments] = await Promise.all([
      ...
      // --- MT: Scope the cancelled appointments count by tenantId ---
      Appointment.countDocuments({
        tenantId: tenantId, // Crucial tenant scope
    ...
    if (stats.uniqueCustomerIds && stats.uniqueCustomerIds.length > 0) {
        // This query is inherently tenant-safe because the IDs come from tenant-scoped invoices.
