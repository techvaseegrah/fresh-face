...
const DEFAULT_STORE_ADMIN_PERMISSIONS = [
  ...
  PERMISSIONS.REPORT_TASK_LIBRARY_READ,
  PERMISSIONS.REPORT_TASK_LIBRARY_MANAGE,
  PERMISSIONS.REPORT_TASK_COMPLIANCE_READ,
  PERMISSIONS.REPORT_TASK_COMPLIANCE_MANAGE,

  // ▼▼▼ ADD THIS BLOCK ▼▼▼
  // New Report Permissions for Expenses, Budget, SOP, and Issues
  PERMISSIONS.REPORT_EXPENSES_READ,
  PERMISSIONS.REPORT_EXPENSES_MANAGE,
  PERMISSIONS.REPORT_BUDGET_VS_ACTUAL_READ,
  PERMISSIONS.REPORT_BUDGET_VS_ACTUAL_MANAGE,
  PERMISSIONS.REPORT_SOP_COMPLIANCE_READ,
  PERMISSIONS.REPORT_SOP_COMPLIANCE_MANAGE,
  PERMISSIONS.REPORT_ISSUE_COMPLIANCE_READ,
  PERMISSIONS.REPORT_ISSUE_COMPLIANCE_MANAGE,
  PERMISSIONS.REPORT_ISSUE_LIBRARY_READ,
  PERMISSIONS.REPORT_ISSUE_LIBRARY_MANAGE,
  // ▲▲▲ END OF ADDITION ▲▲▲
