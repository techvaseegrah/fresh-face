...
const DEFAULT_STORE_ADMIN_PERMISSIONS = [
  ...
  PERMISSIONS.GIFT_CARD_SETTINGS_MANAGE,
  PERMISSIONS.PACKAGES_SETTINGS_READ,
  PERMISSIONS.PACKAGES_SETTINGS_MANAGE,
  ...
  PERMISSIONS.TOOL_STOCK_MANAGE,
  PERMISSIONS.TOOL_STOCK_AUDIT,
  PERMISSIONS.TOOL_STOCK_REPORTS,
