        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
            <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                ...
                <div className="mt-6 flex justify-end space-x-3">
                    ...
                    <button
                        type="button"
                        // FIX: The template literal is now correctly wrapped in curly braces and backticks.
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-4 last:mb-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            {/* FIX: Used template literal correctly inside JSX text node */}
...
export default function EBViewPage() {
  ...
  const handleSetGlobalCost = async (newCost: number) => {
    ...
    try {
      ...
      // FIX: Used template literal correctly in the alert function.
