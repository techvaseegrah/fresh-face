...
export const ALL_PERMISSIONS = [
  ...
  { permission: PERMISSIONS.STAFF_READ, description: 'View general staff information', category: PERMISSION_CATEGORIES.STAFF_MANAGEMENT },
  ...
  // --- ADDED DESCRIPTIONS FOR GRANULAR STAFF PERMISSIONS ---
  { permission: PERMISSIONS.STAFF_LIST_READ, description: 'View staff list', category: PERMISSION_CATEGORIES.STAFF_MANAGEMENT },
  ...
  { permission: PERMISSIONS.STAFF_PERFORMANCE_READ, description: 'View staff performance', category: PERMISSION_CATEGORIES.STAFF_MANAGEMENT },
  ...
  // --- ADDED STORE PERMISSION INFO ---
  { permission: PERMISSIONS.STORE_READ, description: 'View store information', category: PERMISSION_CATEGORIES.STORE_MANAGEMENT },
