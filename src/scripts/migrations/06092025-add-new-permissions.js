...
//   'reports:gift-card-sold:read',   // Permission to view the page and history
//   'reports:gift-card-redemption:read', // Permission to save a daily report
//   'reports:gift-card-sold:manage',
//   'reports:gift-card-redemption:manage', 
  'read:packages-settings',
   'manage:packages-settings',
  // 'packages:reports:read',
  // 'packages:reports:manage',
//   'settings:gift-cards:manage',
  //  'task:read',
  //  'task:manage',
  //  'task:submit_checklist',
  //  'task:reports:read'
// 'settings:gift-cards:manage'
];
